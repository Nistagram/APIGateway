...
func (handler *RegisteredUserHandler) CheckAmIBlocked(w http.ResponseWriter, r *http.Request) {
	params := mux.Vars(r)
	id, _ := strconv.ParseUint(params["user_id"], 10, 64)
	requestURI := handler.Url + "/api/am/i/blocked/" + strconv.FormatUint(id, 10)
